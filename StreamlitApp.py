...
def ingest_into_vectordb(split_docs):
    model_path= r'C:\Users\mneh\Documents\projects\conversational chat with custom data\local model'
...
def get_conversation_chain(vectordb):
    llama_llm = LlamaCpp(
    model_path=r"C:\Users\mneh\Documents\projects\conversational chat with custom data\llama-2-7b-chat.Q4_K_S.gguf",
    temperature=0.75,
    max_tokens=200,
    top_p=1,
    n_ctx=3000)
